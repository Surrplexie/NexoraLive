...
public class NlClientDeepLinkTests
{
    ...
    [Fact]
    public void LaunchBuilder_RimWorld_Clipboard()
    {
        var launch = NlClientLaunchBuilder.Build(new NlClientManifest(
            "sess",
            "st",
            "https://play.example.com",
            "wss://play.example.com/nl/v1",
            "https://play.example.com/api/v1/session/admit",
            "rimworld://play.example.com:25555",
            "AtOwnRisk",
            false,
            true,
            "rimworld",
            "1.0"));
        Assert.Equal("rimworld://play.example.com:25555", launch.NativeConnectClipboard);
    }

    [Fact]
    public void LaunchBuilder_Kenshi_Clipboard()
    {
        var launch = NlClientLaunchBuilder.Build(new NlClientManifest(
            "sess",
            "st",
            ...
            "wss://play.example.com/nl/v1",
            "https://play.example.com/api/v1/session/admit",
            "kenshi://play.example.com:23386",
            "AtOwnRisk",
            false,
            true,
            "kenshi",
            "1.0"));
        Assert.Equal("kenshi://play.example.com:23386", launch.NativeConnectClipboard);
    }
}
