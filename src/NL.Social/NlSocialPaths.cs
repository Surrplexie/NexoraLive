...
public static class NlSocialPaths
{
    ...
    public static string YouTubeCredentials => Path.Combine(Root, "youtube-oauth-credentials.json");

    public static string KickCredentials => Path.Combine(Root, "kick-oauth-credentials.json");
