...
document.getElementById("save-requirements").onclick = async () => {
  var verificationFlags = 0;
  if (document.getElementById("req-verify-email").checked) verificationFlags |= 1;
  if (document.getElementById("req-verify-2fa").checked) verificationFlags |= 4;
  const body = {
