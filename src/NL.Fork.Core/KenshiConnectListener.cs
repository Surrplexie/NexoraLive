...
/// <summary>
/// TCP connect listener for <c>kenshi://host:port</c> (community-MP handshake).
/// Kenshi has no official dedicated server; this banner keeps the orchestrator port mapped
/// and lets NL Client probe readiness without shipping the game.
/// </summary>
public sealed class KenshiConnectListener : IAsyncDisposable
{
    public const string HandshakeBanner = "NL-KENSHI/1 mp-ready\n";
    ...
    public KenshiConnectListener(int port, IPAddress? address = null)
    {
        Port = port;
