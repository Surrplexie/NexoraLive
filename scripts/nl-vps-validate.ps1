...
foreach ($page in @("/play.html", "/ga.html", "/status.html", "/download.html", "/legal-center.html", "/ga-launch-checklist.html")) {
...
if (-not $SkipDogfood) {
    Write-Host "Production dogfood (hello-fork + minecraft + rimworld)..." -ForegroundColor Yellow
