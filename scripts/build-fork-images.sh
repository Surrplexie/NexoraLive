...
for t in "${targets[@]}"; do
  case "$t" in
    ...
    example-game) build_one example-game docker/fork-example-game/Dockerfile nl-fork-example-game:latest ;;
    rimworld) build_one rimworld docker/fork-rimworld/Dockerfile nl-fork-rimworld:latest ;;
    all)
      ...
      build_one minecraft-paper docker/fork-minecraft-paper/Dockerfile nl-fork-minecraft-paper:latest
      build_one beamng docker/fork-beamng/Dockerfile nl-fork-beamng:latest
      build_one example-game docker/fork-example-game/Dockerfile nl-fork-example-game:latest
      build_one rimworld docker/fork-rimworld/Dockerfile nl-fork-rimworld:latest
      ;;
