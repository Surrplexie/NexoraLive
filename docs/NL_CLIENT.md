...
6. Receive launch params (`bridgeConnectUrl`, `forkConnectEndpoint`, `nativeConnectClipboard` for RimWorld)
...
| GET | `/api/v1/t2-lite/status` | Public native connect host (RimWorld) |
