...
| **Per-game smokes** | hello-fork (required), minecraft + beamng + rimworld + kenshi (with `-AllGames`) |
...
### All catalog games (hello-fork + minecraft + beamng + rimworld)
...
- Wire Twitch/Discord OAuth for social-gated dogfood sessions — see [docs/NL_LIVE_SOCIAL_DOGFOOD.md](NL_LIVE_SOCIAL_DOGFOOD.md)
