...
| Ports open | **80**, **443**, **3478** (tcp+udp), **25555/tcp** (RimWorld T2-lite) |
...
See also: [`NL_PRODUCTION_CUTOVER_RUNBOOK.md`](NL_PRODUCTION_CUTOVER_RUNBOOK.md), [`NL_VPS_DEPLOY_RUNBOOK.md`](NL_VPS_DEPLOY_RUNBOOK.md), [`NL_PUBLIC_LINE.md`](NL_PUBLIC_LINE.md)

Public-line defaults: first title **RimWorld**; session-host loopback `27020`/`27021`; `/data` bind-mounted from `NL_FORK_DOCKER_WORKSPACE_HOST_ROOT`.
