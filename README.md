...
| [`docs/NL_MASTER_PLAN.md`](docs/NL_MASTER_PLAN.md) | All phases & tracks — consolidated master plan |
| [`docs/NL_GAME_EXPANSION_PLAN.md`](docs/NL_GAME_EXPANSION_PLAN.md) | Phases T0–T8: adding games toward ideal NL path |
| [`docs/NL_GAME_ADAPTER.md`](docs/NL_GAME_ADAPTER.md) | Phase T0: per-game adapter contract + template |
| [`docs/NL_IDEAL_DEMO_GUIDE.md`](docs/NL_IDEAL_DEMO_GUIDE.md) | Operator VPS + streamer + demo fan (the loop that matters) |
| [`docs/NL_RIMWORLD.md`](docs/NL_RIMWORLD.md) | Phase T1: RimWorld colony fork |
| [`docs/NL_KENSHI.md`](docs/NL_KENSHI.md) | Phase T1: Kenshi outpost fork |
| [`docs/NL_T2_LITE.md`](docs/NL_T2_LITE.md) | T2-lite: public RimWorld connect on VPS |
